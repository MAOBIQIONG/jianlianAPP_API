...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span><img alt="image" class="img-circle" src="<%=basePath%>HPLUS/img/profile_small.jpg" /></span>
                    ...
                    <li>
                        <a href="#">
                            ...
                            <span class="nav-label">微信配置</span>
                            <span class="fa arrow"></span>
                        </a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="wxaccount" data-index="0">公众账号管理</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="index_v2.html">关注欢迎语</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="index_v3.html">消息模板管理</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="index_v4.html">未识别回复语</a>
                            </li>
                            <li>
                                <a href="index_v5.html" target="_blank">关键字管理</a>
                            </li>
                            <li>
                                <a href="index_v5.html" target="_blank">自定义菜单</a>
                            </li>
                        </ul>
                    </li>
                    <li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="main.html" frameborder="0" data-id="index_v1.html" seamless></iframe>
            </div>
            <div class="footer">
    ...
    <script src="<%=basePath%>HPLUS/js/plugins/layer/layer.min.js"></script>
