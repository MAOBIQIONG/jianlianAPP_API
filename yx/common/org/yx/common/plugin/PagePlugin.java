...
import org.yx.common.utils.ReflectHelper;
import org.yx.common.utils.Tools;
/**
 * 
* 类名称：PagePlugin.java
* 类描述： 
	...
	private String generatePageSql(String sql,Page page){
		if(page!=null && Tools.notEmpty(dialect)){
			...
			if("mysql".equals(dialect)){
				pageSql.append(sql);
				//System.out.println(" limit "+page.getCurrentResult()+","+page.getShowCount());
				if(page.getOrderField() != null && page.getOrderField().trim().length() > 0){
					pageSql.append(" order by " + page.getOrderField() + " " + page.getOrderDirection());
				}
